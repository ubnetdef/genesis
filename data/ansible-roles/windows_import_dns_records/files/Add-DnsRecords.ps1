# Stolen from: https://github.com/RITSPARSA/ISTS16-InfrastructureConfiguration
...
Import-Csv $FileName | % {
    ...
    $fqdn = $_.Name.replace("{TEAM}","$TeamNumber")
    $fqdn = $fqdn.replace("{TEAM_PAD}","$TeamNumberPadded")
